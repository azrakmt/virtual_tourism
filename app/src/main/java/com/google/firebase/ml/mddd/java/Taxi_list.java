...
public class Taxi_list extends RecyclerView.Adapter<Taxi_list.ViewHolder>{
    ...
    public Taxi_list(Context context, ArrayList<String> imageNames, ArrayList<String> images,ArrayList<String> t_number,ArrayList<String> t_model,ArrayList<Integer> t_rating ) {
        t_name = imageNames;
        dp = images;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.taxi_details, parent, false);
...
//                mContext.startActivity(intent);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View v) {
            super(v);
            car_model = v.findViewById(R.id.tmodel);
            owner_name = v.findViewById(R.id.tname);
