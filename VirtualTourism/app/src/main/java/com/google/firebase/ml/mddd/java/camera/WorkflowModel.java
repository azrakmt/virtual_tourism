...
package com.google.firebase.ml.mddd.java.camera;
...
public class WorkflowModel extends AndroidViewModel implements SearchResultListener {
  ...
  public final MutableLiveData<FirebaseVisionCloudLandmark> detectedBarcode = new MutableLiveData<FirebaseVisionCloudLandmark>();
